...
then
   plink2 --bfile ${study2_plink_prefix}_common \
   ...
   plink2 --bfile ${study1_plink_prefix}_${study2_plink_prefix}_merged1 --make-bed --out ${study1_plink_prefix}_${study2_plink_prefix}_merged2
fi
...
then
   ...
   plink2 --bfile ${study2_plink_prefix}_common_flipped \
      --exclude ${study1_plink_prefix}_${study2_plink_prefix}_merged2-merge.missnp \
      --make-bed --out ${study2_plink_prefix}_common_no_mismatches
   plink2 --bfile ${study1_plink_prefix}_common_no_mismatches \
   ...
   plink2 --bfile ${study1_plink_prefix}_${study2_plink_prefix}_merged2 \
      --make-bed --out ${study1_plink_prefix}_${study2_plink_prefix}_merged3
fi

#Remove SNPs with large missingness and apply MAF filtere
plink2 --bfile ${study1_plink_prefix}_${study2_plink_prefix}_merged3 \
